 ...
 * @since 3.5.1
 */
class CustomerAverage extends Tile {
	...
	protected function get_id(): string {
		return 'average_revenue_per_customer';
	}
	...
	protected function get_label(): string {
		return __( 'Average Revenue per Customer', 'easy-digital-downloads' );
	}
	...
	protected function get_data(): string {
		...
		return $stats->get_customer_lifetime_value();
	}
}
