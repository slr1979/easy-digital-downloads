 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $beneficiary
 ...
 * @property \EDD\Vendor\Stripe\StripeObject[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 * @property string|\EDD\Vendor\Stripe\Climate\Product $product Unique ID for the Climate <code>Product</code> this order is purchasing.
...
class Order extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Climate\Order the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Climate\Order> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Climate\Order the updated resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Climate\Order the canceled order
     */
