 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $ach_credit_transfer
 * @property null|\EDD\Vendor\Stripe\StripeObject $ach_debit
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $card_present
 * @property string $client_secret The client secret of the source. Used for client-side retrieval using a publishable key.
 * @property null|\EDD\Vendor\Stripe\StripeObject $code_verification
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property null|\EDD\Vendor\Stripe\StripeObject $p24
 * @property null|\EDD\Vendor\Stripe\StripeObject $receiver
 * @property null|\EDD\Vendor\Stripe\StripeObject $redirect
 * @property null|\EDD\Vendor\Stripe\StripeObject $sepa_credit_transfer
 * @property null|\EDD\Vendor\Stripe\StripeObject $sepa_debit
 * @property null|\EDD\Vendor\Stripe\StripeObject $sofort
 * @property null|\EDD\Vendor\Stripe\StripeObject $source_order
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $three_d_secure
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Source the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Source
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Source the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \EDD\Vendor\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Source the detached source
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\SourceTransaction> list of source transactions
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Source the verified source
     */
