...
class OAuthService extends \EDD\Vendor\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \EDD\Vendor\Stripe\StripeObject the object returned by Stripe's Connect API
     */
    ...
    public function authorizeUrl($params = null, $opts = null)
    {
        ...
        $query = \EDD\Vendor\Stripe\Util\Util::encodeParameters($params);
     ...
     * @param null|array $opts
     *
     * @throws \EDD\Vendor\Stripe\Exception\OAuth\OAuthErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\StripeObject object containing the response from the API
     */
     ...
     * @param array|\EDD\Vendor\Stripe\Util\RequestOptions $opts the special modifiers of the request
     *
     * @throws \EDD\Vendor\Stripe\Exception\InvalidArgumentException
     *
     * @return \EDD\Vendor\Stripe\Util\RequestOptions
     */
    private function _parseOpts($opts)
    {
        if (\is_array($opts)) {
            if (\array_key_exists('connect_base', $opts)) {
                ...
                throw new \EDD\Vendor\Stripe\Exception\InvalidArgumentException('Use `api_base`, not `connect_base`');
            }
        }
        return \EDD\Vendor\Stripe\Util\RequestOptions::parse($opts);
    }
    /**
