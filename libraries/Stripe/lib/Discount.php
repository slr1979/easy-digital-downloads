 ...
 * @property null|string|\EDD\Vendor\Stripe\Customer $customer The ID of the customer associated with this discount.
 ...
 * @property null|string|\EDD\Vendor\Stripe\PromotionCode $promotion_code The promotion code applied to create this discount.
