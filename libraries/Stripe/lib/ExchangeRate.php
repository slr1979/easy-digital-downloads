 ...
 * @property \EDD\Vendor\Stripe\StripeObject $rates Hash where the keys are supported currencies and the values are the exchange rate at which the base id currency converts to the key currency.
 */
class ExchangeRate extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\ExchangeRate> of ApiResources
     */
