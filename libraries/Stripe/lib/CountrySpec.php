 ...
 * @property \EDD\Vendor\Stripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \EDD\Vendor\Stripe\StripeObject $verification_fields
 */
