 ...
 * @property null|string|\EDD\Vendor\Stripe\Charge $charge ID of the charge that's refunded.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $destination_details
 * @property null|string|\EDD\Vendor\Stripe\BalanceTransaction $failure_balance_transaction After the refund fails, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $next_action
 * @property null|string|\EDD\Vendor\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's refunded.
 ...
 * @property null|string|\EDD\Vendor\Stripe\TransferReversal $source_transfer_reversal The transfer reversal that's associated with the refund. Only present if the charge came from another Stripe account.
 ...
 * @property null|string|\EDD\Vendor\Stripe\TransferReversal $transfer_reversal This refers to the transfer reversal object if the accompanying transfer reverses. This is only applicable if the charge was created using the destination parameter.
 */
class Refund extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Refund the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Refund> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Refund the updated resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Refund the canceled refund
     */
