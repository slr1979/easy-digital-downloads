 ...
 * @property string|\EDD\Vendor\Stripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\EDD\Vendor\Stripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Radar\EarlyFraudWarning> of ApiResources
     */
