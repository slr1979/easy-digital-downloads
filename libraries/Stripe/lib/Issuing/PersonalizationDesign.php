 ...
 * @property null|string|\EDD\Vendor\Stripe\File $card_logo The file for the card logo to use with physical bundles that support card logos. Must have a <code>purpose</code> value of <code>issuing_logo</code>.
 * @property null|\EDD\Vendor\Stripe\StripeObject $carrier_text Hash containing carrier text, for use with physical bundles that support carrier text.
 ...
 * @property string|\EDD\Vendor\Stripe\Issuing\PhysicalBundle $physical_bundle The physical bundle object belonging to this personalization design.
 * @property \EDD\Vendor\Stripe\StripeObject $preferences
 * @property \EDD\Vendor\Stripe\StripeObject $rejection_reasons
...
class PersonalizationDesign extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Issuing\PersonalizationDesign the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Issuing\PersonalizationDesign> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Issuing\PersonalizationDesign the updated resource
     */
