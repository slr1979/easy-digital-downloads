 ...
 * @property null|string|\EDD\Vendor\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\EDD\Vendor\Stripe\StripeObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Dispute> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Dispute the updated resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Dispute the closed dispute
     */
