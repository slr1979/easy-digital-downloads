 ...
 * @property \EDD\Vendor\Stripe\StripeObject $balance Balance information for the FinancialAccount
 ...
 * @property null|\EDD\Vendor\Stripe\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. Stripe or the platform can control Features via the requested field.
 * @property \EDD\Vendor\Stripe\StripeObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 */
class FinancialAccount extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Treasury\FinancialAccount the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Treasury\FinancialAccount> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Treasury\FinancialAccount
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Treasury\FinancialAccount the updated resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Treasury\FinancialAccountFeatures the retrieved financial account features
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Treasury\FinancialAccountFeatures the updated financial account features
     */
