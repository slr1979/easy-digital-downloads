 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property \EDD\Vendor\Stripe\StripeObject $linked_flows
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property null|string|\EDD\Vendor\Stripe\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class InboundTransfer extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Treasury\InboundTransfer the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Treasury\InboundTransfer> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Treasury\InboundTransfer the canceled inbound transfer
     */
