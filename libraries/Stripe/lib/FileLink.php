 ...
 * @property string|\EDD\Vendor\Stripe\File $file The file object this link points to.
...
class FileLink extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\FileLink the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\FileLink> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\FileLink
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\FileLink the updated resource
     */
