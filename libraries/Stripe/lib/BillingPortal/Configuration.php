 ...
 * @property null|string|\EDD\Vendor\Stripe\Application $application ID of the Connect Application that created the configuration.
 * @property \EDD\Vendor\Stripe\StripeObject $business_profile
 ...
 * @property \EDD\Vendor\Stripe\StripeObject $login_page
...
class Configuration extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\BillingPortal\Configuration the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\BillingPortal\Configuration> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\BillingPortal\Configuration the updated resource
     */
