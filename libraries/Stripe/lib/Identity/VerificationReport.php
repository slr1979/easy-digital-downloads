 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $document Result from a document check
 * @property null|\EDD\Vendor\Stripe\StripeObject $email Result from a email check
 * @property null|\EDD\Vendor\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\EDD\Vendor\Stripe\StripeObject $options
 * @property null|\EDD\Vendor\Stripe\StripeObject $phone Result from a phone check
 * @property null|\EDD\Vendor\Stripe\StripeObject $selfie Result from a selfie check
...
class VerificationReport extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Identity\VerificationReport> of ApiResources
     */
