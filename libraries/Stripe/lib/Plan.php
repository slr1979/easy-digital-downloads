 ...
 * @property null|string|\EDD\Vendor\Stripe\Product $product The product whose pricing this plan determines.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $transform_usage Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
...
class Plan extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Plan the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Plan the deleted resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Plan> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Plan the updated resource
     */
