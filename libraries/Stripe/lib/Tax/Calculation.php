 ...
 * @property null|\EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Tax\CalculationLineItem> $line_items The list of items the customer is purchasing.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $shipping_cost The shipping cost details for the calculation.
 ...
 * @property \EDD\Vendor\Stripe\StripeObject[] $tax_breakdown Breakdown of individual tax amounts that add up to the total.
...
class Calculation extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Tax\Calculation the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Tax\Calculation
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Tax\CalculationLineItem> list of calculation line items
     */
