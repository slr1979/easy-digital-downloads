 ...
 * @property null|string|\EDD\Vendor\Stripe\Charge $charge The charge associated with this review.
 ...
 * @property null|\EDD\Vendor\Stripe\StripeObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
...
class Review extends ApiResource
{
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Review the approved review
     */
