 ...
 * @property \EDD\Vendor\Stripe\StripeObject $parameters
 ...
 * @property null|\EDD\Vendor\Stripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
...
class ReportRun extends \EDD\Vendor\Stripe\ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\Reporting\ReportRun the created resource
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Collection<\EDD\Vendor\Stripe\Reporting\ReportRun> of ApiResources
     */
     ...
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\Reporting\ReportRun
     */
