...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @return \EDD\Vendor\Stripe\EphemeralKey the deleted resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \EDD\Vendor\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \EDD\Vendor\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \EDD\Vendor\Stripe\EphemeralKey the created key
     */
