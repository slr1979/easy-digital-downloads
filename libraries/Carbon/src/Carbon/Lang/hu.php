...
}, 'lastDay' => '[tegnap] LT[-kor]', 'lastWeek' => function (CarbonInterface $date) use ($huWeekEndings) {
    return '[múlt ' . $huWeekEndings[$date->dayOfWeek] . '] LT[-kor]';
}, 'sameElse' => 'L'], 'meridiem' => ['DE', 'DU'], 'first_day_of_week' => 1, 'day_of_first_week_of_year' => 4, 'list' => [', ', ' és ']];