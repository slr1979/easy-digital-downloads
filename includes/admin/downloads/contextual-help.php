	...
	$screen->add_help_tab(
		array(
			...
			'content' =>
				...
				'<p>' . sprintf(
					/* translators: 1: Shortcodes Codex URL, 2: EDD Documentation URL */
					__( 'For more information, see <a href="%1$s">using Shortcodes</a> on the WordPress.org Codex or <a href="%2$s">Easy Digital Downloads Documentation</a>', 'easy-digital-downloads' ),
