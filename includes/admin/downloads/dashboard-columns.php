...
remove_filter( 'edd_download_columns', 'edd_fd_fes_download_table_columns' );
remove_action( 'manage_posts_custom_column', 'edd_fd_render_download_columns' );
...
function edd_price_field_quick_edit( $column_name, $post_type ) {
	...
	if ( 'price' !== $column_name || 'download' !== $post_type ) {
		return;
	}
	?>
